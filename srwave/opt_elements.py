...
class Propagation:
    ...
    def __getitem__(self, key:_PropParams):
        if key in self.params:
            ...
            return self._prop_params['h_ra'], self._prop_params['v_ra']
        elif key=='re':
            return self._prop_params['h_re'], self._prop_params['v_re']
        else:
    ...
    def __setitem__(self, key, value):
        if key in self.params:
            ...
            self._prop_params['h_ra'] = value
            self._prop_params['v_ra'] = value
        elif key=='re':
            self._prop_params['h_re'] = value
            self._prop_params['v_re'] = value
        else:
            raise KeyError(f"Param '{key}' not found")
